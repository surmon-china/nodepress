...
let CommentEffectService = class CommentEffectService {
    articleStatsService;
    commentModel;
    constructor(articleStatsService, commentModel) {
    ...
    async syncArticleCommentCounts(articleIds) {
        try {
            ...
            await Promise.all(articleIds.map((id) => this.articleStatsService.updateStatsComments(id, countMap.get(id) || 0)));
        }
        catch (error) {
...
exports.CommentEffectService = CommentEffectService = __decorate([
    ...
    __metadata("design:paramtypes", [article_service_stats_1.ArticleStatsService, Object])
