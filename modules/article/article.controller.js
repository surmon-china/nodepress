...
__decorate([
    ...
    http_decorator_1.HttpProcessor.handle('获取文章'),
...
__decorate([
    ...
    http_decorator_1.HttpProcessor.handle('添加文章'),
...
__decorate([
    (0, common_1.Patch)(),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    http_decorator_1.HttpProcessor.handle('批量更新文章'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Delete)(),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    http_decorator_1.HttpProcessor.handle('批量删除文章'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    http_decorator_1.HttpProcessor.handle('修改文章'),
    __param(0, (0, query_params_decorator_1.QueryParams)()),
...
__decorate([
    ...
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    http_decorator_1.HttpProcessor.handle('删除单个文章'),
    __param(0, (0, query_params_decorator_1.QueryParams)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
